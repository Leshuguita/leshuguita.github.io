...
- {% favilink(t="https://xeiaso.net/") %}:
A ton of articles and posts on technology, the internet, and that sort of stuff.
{% end %}
- {% favilink(t="https://vkc.sh/", i="/wp-content/uploads/2024/04/cropped-me-200-dither-32x32.jpg") %}:
Blog and videos about Linux, Open Source, and related stuff.
{% end %}
...
A very good game, Dr. Robotnik's Ring Racers. It's a Sonic-themed racing game using Doom's engine. It has a bunch of community-made [addons](https://mb.srb2.org/forums/ring-racers-addons-more-discussion.113/), and it's [open source.](https://git.srb2.org/KartKrew/)
{% end %}
