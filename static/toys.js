 ...
 */
export function init_random_toy(canvas_id) {
    const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.init_random_toy(ptr0, len0);
}
 ...
 * @param {number} delta
 */
export function update_toy(canvas_id, delta) {
    const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.update_toy(ptr0, len0, delta);
}
 ...
 * @returns {string}
 */
export function toy_url(lang) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(lang, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.toy_url(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function toy_text(lang) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(lang, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.toy_text(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 */
export function toy_cursor() {
    const ret = wasm.toy_cursor();
    let v1;
    if (ret[0] !== 0) {
 ...
 */
export function toy_mouse_move(new_x, new_y, pressed) {
    wasm.toy_mouse_move(new_x, new_y, pressed);
}
 ...
 * @param {number} button
 */
export function toy_mouse_click(x, y, button) {
    wasm.toy_mouse_click(x, y, button);
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_708631e9d15dda51 = function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('toys_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
